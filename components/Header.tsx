    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          {/* Location */}
          <div className="hidden lg:flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-xl cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            <FiMapPin className="text-blue-600" />
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">Location</p>
              <p className="text-sm font-semibold">Chennai 600000</p>
            </div>
          </div>
      ...
      {isMenuOpen && (
        ...
        >
          <nav className="flex flex-col gap-2">
            ...
            <a href="#locations" className="px-4 py-3 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              Locations
            </a>
          </nav>
        </motion.div>
